/*
    ScoreBoard.java - Paddle Ball Game
...
public class ScoreBoard extends JPanel{
	...
	public ScoreBoard(){
		...
		score1.setFont(new Font("Monospaced",Font.BOLD,70));
		score1.setForeground(Color.WHITE);
		
		score2 = new JLabel();
		score2.setText(" " + p2_score);
		score2.setFont(new Font("Monospaced",Font.BOLD,70));
